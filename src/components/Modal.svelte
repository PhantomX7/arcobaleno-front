			...
			>
				{#if state.closeButton}
					...
					{:else}
						<button
							type="button"
                            on:click={close} style={cssCloseButton}
							class="close bg-white rounded-md text-gray-400 hover:text-gray-500"
						>
					...
					{/if}
				{/if}
				<div class="content overflow-y-hidden" style={cssContent}>
